...
export const Button = (props: ParentProps<ButtonProps>) => {
  ...
  const [local, restOfProps] = splitProps(
    ...
    ['children', 'context', 'size', 'state', 'preIcon', 'postIcon', 'variant', 'disabled', 'loadingIconPosition'],
  );
  ...
  return (
    <button
      class={classnames(styles.button, {
        ...
        [styles.primary]: local.context === ButtonContext.PRIMARY && useVariant !== ButtonVariant.LINK,
        [styles.safe]: local.context === ButtonContext.SAFE && useVariant !== ButtonVariant.LINK,
        [styles.warning]: local.context === ButtonContext.WARNING && useVariant !== ButtonVariant.LINK,
        [styles.danger]: local.context === ButtonContext.DANGER && useVariant !== ButtonVariant.LINK,
